class Userparam < ApplicationRecord
    ...
    validates :firstname, :nickname, :lastname, :age, presence: true
    validates :age, numericality: { only_integer: true, message: "only allows int" }
    validates :firstname, :nickname, :lastname, format: { with: /\A[a-zA-Z]+\z/,
    message: "only allows letters" }
    validates :lastname, :nickname, :firstname, length: { in: 3..20 }
